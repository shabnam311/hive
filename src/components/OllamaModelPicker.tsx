...
// Dropdown to pick which locally available Ollama model to use.
      ...
      >
        <span
          style={{
            ...
            borderRadius: "50%",
            background: "#7ab840",
            boxShadow: "0 0 6px rgba(122,184,64,0.8)",
            flexShrink: 0,
          }}
        />
        {displayName}
        {models.length > 1 && (
          <span style={{ opacity: 0.5, marginLeft: "0.1rem" }}>▾</span>
        )}
      </button>
            ...
            {models.map((m) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: "5px",
                  border: "none",
                  background: m.name === selectedModel ? "rgba(201,168,76,0.12)" : "transparent",
                  color: m.name === selectedModel ? "#c9a84c" : "#a09070",
                  fontSize: "0.8rem",
                  cursor: "pointer",
                  textAlign: "left",
              ...
              >
                ...
                <span style={{ opacity: 0.5, fontSize: "0.7rem", flexShrink: 0 }}>
                  {m.sizeGB}GB
                </span>
              </button>
            ))}

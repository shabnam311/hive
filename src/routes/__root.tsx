...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "HIVE — your grimoire. your rules. your universe." },
      {
        property: "og:description",
        content:
          "A locally-powered personal life OS with planner, library, diary, finance tracker, and a cozy 3D den.",
      },
